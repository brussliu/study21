...
(function() {
  ...
  const CATEGORIES = [
    ...
    { id: 'translation', label: '単語翻訳発音', icon: 'fa-language', description: '中国語・日本語の単語・例文翻訳APIと、英語の単語・例文発音取得API、同時処理数を設定します。', fields: [
      ...
      f('jaWordApi','日本語・単語翻訳API','日本語翻訳','select',['ExcelAPI','Google','YouDao']), f('jaSentenceApi','日本語・例文翻訳API','日本語翻訳','select',['ExcelAPI','Google','YouDao']), f('jaThreads','日本語・処理スレッド数','日本語翻訳','number',null,'1～20',1,20),
      f('enVoiceWordApi','単語発音取得API','英語発音','select',['YouDao','Google']), f('enVoiceSentenceApi','例文発音取得API','英語発音','select',['YouDao','Google']), f('enVoiceThreads','処理スレッド数','英語発音','number',null,'1～20',1,20)
    ]},
    { id: 'batchai', label: '単語情報生成', icon: 'fa-robot', description: '初級編英訳中日問題（batC04）と中国語・日本語の単語説明生成（batC05/batC06）を3つのバッチで設定します。API KeyとURLは「AIモデル」の接続設定を共通利用します。', sections: [
      ...
      rangeField(tabField(f('c04Threads','スレッド数','batC04 初級編','range',null,'初級編問題を同時生成するスレッド数です。',1,20),'基本設定'),1,'',''),
      ...
      rangeField(tabField(f('c05Threads','スレッド数','batC05','range',null,'中国語説明を同時生成するスレッド数です。',1,20),'基本設定'),1,'',''),
      ...
      rangeField(tabField(f('c06Threads','スレッド数','batC06','range',null,'日本語説明を同時生成するスレッド数です。',1,20),'基本設定'),1,'',''),
    ...
    { id: 'image', label: '画像共通処理', icon: 'fa-image', description: '共通AI OCR（batC91）の実行条件とプロンプトを設定します。API KeyとURLは「AIモデル」の接続設定を共通利用します。', sections: [
      ...
      rangeField(tabField(f('intensiveMaxImageMb','画像1枚の最大サイズ','batC91','range',null,'画像1枚あたりの最大サイズ（MB）です。',1,100),'基本設定'),1,'MB',''),
      rangeField(tabField(f('intensiveOcrTimeoutSeconds','リクエストタイムアウト','batC91','range',null,'AI APIへの1回の通信を待つ最大秒数です。',30,1800),'基本設定'),10,'s',''),
      rangeField(tabField(f('intensiveOcrMaxImagePixels','AI送信画像の最大辺','batC91','range',null,'OCRでAIへ送信する画像の最大辺ピクセルです。超える場合は縮小します。',512,8192),'基本設定'),64,'px',''),
    ...
    { id: 'essay', label: '英作文AI添削', icon: 'fa-file-signature', description: '英作文の画像分類・OCRと英検基準AI添削を2つのバッチで設定します。API KeyとURLは「AIモデル」の接続設定を共通利用します。', sections: [
      ...
      rangeField(tabField(f('essayMaxImageMb','画像1枚の最大サイズ','batC11','range',null,'画像1枚あたりの最大サイズ（MB）です。',1,100),'基本設定'),1,'MB',''),
      fullField(tabField(aiModelDropdownField('essayOcrAiProvider','batC11','画像の分類・OCRで使用するモデルです。',true),'基本設定')),
      rangeField(tabField(f('essayOcrMaxImagePixels','AI送信画像の最大辺','batC11','range',null,'OCRでAIへ送信する画像の最大辺ピクセルです。超える場合は縮小します。',512,8192),'基本設定'),64,'px',''),
      rangeField(tabField(f('essayOcrRequestTimeoutSeconds','リクエストタイムアウト','batC11','range',null,'AI APIへの1回の通信を待つ最大秒数です。',30,1800),'基本設定'),10,'s',''),
    ...
    { id: 'english_cloze', label: '英語穴埋め問題', icon: 'fa-puzzle-piece', description: '穴埋め問題画像のOCR・構造化と問題ごとのAI解説を2つのバッチで設定します。API KeyとURLは「AIモデル」の接続設定を共通利用します。', sections: [
      ...
      rangeField(tabField(f('clozeMaxImageMb','画像1枚の最大サイズ','batC13','range',null,'画像1枚あたりの最大サイズ（MB）です。',1,100),'基本設定'),1,'MB',''),
      fullField(tabField(aiModelDropdownField('clozeOcrAiProvider','batC13','画像OCR・問題構造化で使用するモデルです。',true),'基本設定')),
      rangeField(tabField(f('clozeOcrMaxImagePixels','AI送信画像の最大辺','batC13','range',null,'OCRでAIへ送信する画像の最大辺ピクセルです。超える場合は縮小します。',512,8192),'基本設定'),64,'px',''),
      rangeField(tabField(f('clozeOcrTimeoutSeconds','リクエストタイムアウト','batC13','range',null,'AI APIへの1回の通信を待つ最大秒数です。',30,1800),'基本設定'),10,'s',''),
      ...
      rangeField(tabField(f('clozeExplanationBatchMax','1回の最大生成問題数','batC14','range',null,'一覧の「AI解説を生成」で1回に受け付ける問題数です。',1,100),'基本設定'),1,'問',''),
      ...
      rangeField(tabField(f('clozeExplanationRequestTimeoutSeconds','リクエストタイムアウト','batC14','range',null,'AI APIへの1回の通信を待つ最大秒数です。',30,1800),'基本設定'),10,'s',''),
    ...
    { id: 'english_reading_intensive', label: '英語読解・精読', icon: 'fa-book-open', description: '長文画像をOCRし、導読・逐文精読・設問解析を生成する4段階処理を設定します。API KeyとURLは「AIモデル」の接続設定を共通利用します。', sections: [
      ...
      rangeField(tabField(f('intensiveExplanationTimeoutSeconds','リクエストタイムアウト','batC17','range',null,'AI APIへの1回の通信を待つ最大秒数です。',30,1800),'基本設定'),10,'s',''),
      rangeField(tabField(f('intensiveExplanationBatchSize','1回の最大文数','batC17','range',null,'長文を分割してAIへ送る際の1リクエストあたり文数です。超える場合は自動分割します。',1,50),'基本設定'),1,'文',''),
      rangeField(tabField(f('intensiveExplanationThreads','スレッド数','batC17','range',null,'複数バッチを同時に処理するスレッド数です。API制限に応じて調整できます。',1,5),'基本設定'),1,'',''),
      ...
      rangeField(tabField(f('intensiveQuestionTimeoutSeconds','リクエストタイムアウト','batC18','range',null,'AI APIへの1回の通信を待つ最大秒数です。',30,1800),'基本設定'),10,'s',''),
    ...
    { id: 'study_monitor', label: '学習状況モニター', icon: 'fa-video', description: '動画の取込時間帯、スナップショット、およびAI分析条件を設定します。', sections: [
      ...
      rangeField(tabField(f('monitorSnapshotIntervalSeconds','スナップショット間隔（秒）','基本設定','range',null,'batL02 が動画から画像を切り出す間隔です。',1,3600),'基本設定'),1,'秒',''),
      ...
      rangeField(tabField(f('monitorAiBatchLimit','1回のAI分析枚数','基本設定','range',null,'batL03 を手動実行したときに分析する最大画像数です。',1,100),'基本設定'),1,'枚',''),
    ...
    { id: 'english_word_detail_ai', label: '英単語詳細AI取得', icon: 'fa-robot', description: '単語母表から詳細知識をAI Batchで生成し、中級編D・Eの問題データを生成する設定です。', sections: [
      ...
      rangeField(tabField(f('wordDetailAiThreads','スレッド数','batC21','range',null,'同時に処理する単語詳細取得スレッド数です。',1,20),'基本設定'),1,'',''),
      rangeField(tabField(f('wordDetailAiRequestTimeoutSeconds','リクエストタイムアウト','batC21','range',null,'AI APIへの1回の通信を待つ最大秒数です。',30,1800),'基本設定'),10,'s',''),
      ...
      rangeField(tabField(f('c042Threads','スレッド数','batC22 中級編','range',null,'中級編データを同時生成するスレッド数です。',1,20),'基本設定'),1,'',''),
      rangeField(tabField(f('c042RequestTimeoutSeconds','リクエストタイムアウト','batC22 中級編','range',null,'AI APIへの1回の通信を待つ最大秒数です。',30,1800),'基本設定'),10,'s',''),
      ...
      rangeField(tabField(f('c043Threads','スレッド数','batC23 中級編','range',null,'E問題を同時生成するスレッド数です。',1,20),'基本設定'),1,'',''),
      rangeField(tabField(f('c043RequestTimeoutSeconds','リクエストタイムアウト','batC23 中級編','range',null,'AI APIへの1回の通信を待つ最大秒数です。',30,1800),'基本設定'),10,'s',''),
    ...
    { id: 'english_phrase_detail_ai', label: '英熟語詳細AI取得', icon: 'fa-link', description: '熟語の標準化・分類、詳細情報取得、およびD・E問題データ生成のAI設定です。', sections: [
      ...
      rangeField(tabField(f('phraseStandardizationAiThreads','スレッド数','基本設定','range',null,'標準化と分類を同時に処理する熟語数です。',1,20),'基本設定'),1,'',''),
      rangeField(tabField(f('phraseStandardizationAiRequestTimeoutSeconds','リクエストタイムアウト','基本設定','range',null,'AI APIへの1回の通信を待つ最大秒数です。',30,1800),'基本設定'),10,'s',''),
      ...
      rangeField(tabField(f('phraseStandardizationAiTemperature','Temperature','基本設定','range',null,'低い値ほど表記と分類が安定します。',0,1),'基本設定'),0.1,'',''),
      ...
      rangeField(tabField(f('phraseDetailAiThreads','スレッド数','基本設定','range',null,'熟語詳細を同時に処理するスレッド数です。',1,20),'基本設定'),1,'',''),
      rangeField(tabField(f('phraseDetailAiRequestTimeoutSeconds','リクエストタイムアウト','基本設定','range',null,'AI APIへの1回の通信を待つ最大秒数です。',30,1800),'基本設定'),10,'s',''),
      ...
      rangeField(tabField(f('phraseDetailAiTemperature','Temperature','基本設定','range',null,'低い値ほど構造化された詳細知識を安定して生成できます。',0,1),'基本設定'),0.1,'',''),
      ...
      rangeField(tabField(f('c23Threads','スレッド数','batC33 熟語D','range',null,'熟語Dデータを同時生成するスレッド数です。',1,20),'基本設定'),1,'',''),
      rangeField(tabField(f('c23RequestTimeoutSeconds','リクエストタイムアウト','batC33 熟語D','range',null,'AI APIへの1回の通信を待つ最大秒数です。',30,1800),'基本設定'),10,'s',''),
      ...
      rangeField(tabField(f('c24Threads','スレッド数','batC34 熟語E','range',null,'熟語E問題を同時生成するスレッド数です。',1,20),'基本設定'),1,'',''),
      rangeField(tabField(f('c24RequestTimeoutSeconds','リクエストタイムアウト','batC34 熟語E','range',null,'AI APIへの1回の通信を待つ最大秒数です。',30,1800),'基本設定'),10,'s',''),
    ...
    { id: 'japanese_word_ai', label: '日本語単語AI', icon: 'fa-spell-check', description: '日本語単語の詳細情報とC・D・E問題を生成する4つのバッチ設定です。API KeyとURLは「AIモデル」の接続設定を共通利用します。', sections: [
      ...
      rangeField(tabField(f('c25BatchMax','1回の最大単語数','batC41','range',null,'詳細情報取得で一度に受け付ける単語数です。',1,100),'基本設定'),1,'語',''),
      rangeField(tabField(f('c25Threads','スレッド数','batC41','range',null,'詳細情報を同時処理する単語数です。',1,10),'基本設定'),1,'',''),
      rangeField(tabField(f('c25RequestTimeoutSeconds','リクエストタイムアウト','batC41','range',null,'AI APIへの1回の通信を待つ最大秒数です。',30,1800),'基本設定'),10,'s',''),
      ...
      rangeField(tabField(f('c26BatchMax','1回の最大単語数','batC42','range',null,'C問題取得で一度に受け付ける単語数です。',1,100),'基本設定'),1,'語',''),
      rangeField(tabField(f('c26Threads','スレッド数','batC42','range',null,'C問題を同時処理する単語数です。',1,10),'基本設定'),1,'',''),
      rangeField(tabField(f('c26RequestTimeoutSeconds','リクエストタイムアウト','batC42','range',null,'AI APIへの1回の通信を待つ最大秒数です。',30,1800),'基本設定'),10,'s',''),
      ...
      rangeField(tabField(f('c27BatchMax','1回の最大単語数','batC43','range',null,'D問題取得で一度に受け付ける単語数です。',1,100),'基本設定'),1,'語',''),
      rangeField(tabField(f('c27Threads','スレッド数','batC43','range',null,'D問題を同時処理する単語数です。',1,10),'基本設定'),1,'',''),
      rangeField(tabField(f('c27RequestTimeoutSeconds','リクエストタイムアウト','batC43','range',null,'AI APIへの1回の通信を待つ最大秒数です。',30,1800),'基本設定'),10,'s',''),
      ...
      rangeField(tabField(f('c28BatchMax','1回の最大単語数','batC44','range',null,'E問題取得で一度に受け付ける単語数です。',1,100),'基本設定'),1,'語',''),
      rangeField(tabField(f('c28Threads','スレッド数','batC44','range',null,'E問題を同時処理する単語数です。',1,10),'基本設定'),1,'',''),
      rangeField(tabField(f('c28RequestTimeoutSeconds','リクエストタイムアウト','batC44','range',null,'AI APIへの1回の通信を待つ最大秒数です。',30,1800),'基本設定'),10,'s',''),
   ...
   */
  function defaultAiTab(field) {
    if (/UserPrompt/i.test(field.key)) return 'User Prompt';
    if (/Prompt/i.test(field.key)) return 'System Prompt';
    if (/RetryLimit/i.test(field.key)) return 'その他';
    return '基本設定';
  }
  ...
  function configureAiCategory(categoryId, sectionDefinitions) {
    ...
    category.sections = sectionDefinitions.map(function(definition) {
      ...
      fields.forEach(function(field) {
        field.tab = definition.resolveTab ? definition.resolveTab(field) : defaultAiTab(field);
      });
      const preferredTabs = definition.tabs || ['基本設定', 'System Prompt', 'User Prompt', 'その他'];
  ...
  function renderPage() {
    byId('settingCategoryNav').innerHTML = normalizeIcons(CATEGORIES.map(function(category, index) {
      return '<button type="button" class="setting-category-btn' + (index === 0 ? ' active' : '') + '" data-category="' + category.id + '"><i class="fas ' + category.icon + '"></i><span>' + escapeHtml(category.label) + '</span><small>' + category.fields.length + '</small></button>';
    }).join(''));
  ...
  function renderField(field) {
    ...
    if (field.type === 'select' || field.type === 'ai-model-select') {
      ...
      control = '<div class="setting-radio-group' + (field.disabled ? ' is-disabled' : '') + '" id="setting_' + field.key + '">' + options.map(function(option) {
      ...
      control = '<div class="setting-check-group" id="setting_' + field.key + '">' + field.options.map(function(option) { return '<label class="setting-check-option"><input type="checkbox" value="' + escapeHtml(option) + '"' + (selected.includes(option) ? ' checked' : '') + '> ' + escapeHtml(option) + '</label>'; }).join('') + '</div>';
    } else {
    ...
    return '<div class="setting-field' + (field.type === 'textarea' || field.full ? ' full' : '') + (field.type === 'range' ? ' setting-range-field' : '') + (field.disabled ? ' is-disabled' : '') + '"><label class="setting-label" for="setting_' + field.key + '"><span>' + escapeHtml(field.label) + '</span><small class="setting-field-key">' + escapeHtml(field.key) + '</small></label>' + control + testControl + (field.help ? '<p class="setting-help">' + escapeHtml(field.help) + '</p>' : '') + '</div>';
  }
  ...
  function loadSettings() {
    ...
    postJson('/api/admin/setting/initSettings', { userId:'setting.jsp' }).then(function(data) {
      ...
      if (CATEGORIES.some(function(item) { return item.id === requested; })) activateCategory(requested);
  ...
  function saveSettings() {
    ...
    button.innerHTML = '<i class="fas fa-circle-notch fa-spin"></i> 保存中';
    ...
    }).catch(function(error) { showToast(error.message || '設定の保存に失敗しました。'); }).finally(function() { button.disabled=false; button.innerHTML='<i class="fas fa-save"></i> 設定を保存'; });
  }

  function testAiConnection(button) {
    const provider = button.dataset.provider;
    const prefix = provider === 'openai' ? 'chatgpt' : provider;
    const values = collectValues();
    const status = byId('setting_test_status_' + provider);
    button.disabled = true;
    button.innerHTML = '<i class="fas fa-circle-notch fa-spin"></i> テスト中';
    if (status) { status.textContent = ''; status.className = 'setting-api-test-status'; }
    postJson('/api/admin/setting/testAi', { provider: provider, model: values[prefix + 'Model'], apiKey: values[prefix + 'ApiKey'], url: values[prefix + 'Url'] })
      .then(function(data) {
        const message = data.message || '接続成功';
      ...
      .finally(function() { button.disabled = false; button.innerHTML = '<i class="fas fa-plug"></i> 接続テスト'; });
  }
  ...
  window.__study21SystemSettings = { mount: bootstrap };
})();
